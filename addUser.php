...
<?php endif ?>
    ...
    <h1 class="text-danger text-center fw-bold mt-4">Add New User Form</h1>
	...
	<form method="post" action="addUser.php">
		...
		<button type="submit" class ="btn btn-danger fs-5" value="Register" id="register">Add New User</button>	
	</form><br>
